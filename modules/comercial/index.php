...
<div class="page-header">
  <div>
    <h4 class="page-header-title"><i class="bi bi-briefcase me-2"></i>Requerimientos Comerciales</h4>
    <p class="page-header-sub"><?= count($convenios) ?> requerimiento(s)</p>
  </div>
  <div class="d-flex gap-2 flex-wrap">
    <a href="<?= APP_URL ?>/modules/comercial/form.php" class="btn btn-primary btn-sm fw-bold">
